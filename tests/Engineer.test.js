...
describe('Engineer', () => {
    it('should return engineer object', () => {
        const engineer = new Engineer("Chelsea", 2, "chelseaburnham0@gmail.com", "Engineer", "chelseaburnham");
        expect(engineer).toEqual({name: "Chelsea", id: 2, email: "chelseaburnham0@gmail.com", role: "Engineer", github: "chelseaburnham"});
  });
})
