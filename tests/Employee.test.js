...
describe('Employee', () => {
    it('should return employee object', () => {
        const employee = new Employee("Chelsea", 2, "chelseaburnham0@gmail.com", "Employee");
        expect(employee).toEqual({name: "Chelsea", id: 2, email: "chelseaburnham0@gmail.com", role: "Employee"});
  });
})
